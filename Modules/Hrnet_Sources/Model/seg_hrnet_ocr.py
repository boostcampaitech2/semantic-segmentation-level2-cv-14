...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config, **kwargs):
        ...
        extra = config['MODEL']['EXTRA'] #config.MODEL.EXTRA
        super(HighResolutionNet, self).__init__()
        ALIGN_CORNERS = config['MODEL']['ALIGN_CORNERS'] #config.MODEL.ALIGN_CORNERS
        ...
        ocr_mid_channels = config['MODEL']['OCR']['MID_CHANNELS'] #config.MODEL.OCR.MID_CHANNELS
        ocr_key_channels = config['MODEL']['OCR']['KEY_CHANNELS'] #config.MODEL.OCR.KEY_CHANNELS
...
def get_seg_model(cfg, **kwargs):
    ...
    model.init_weights(cfg['MODEL']['PRETRAINED']) #cfg.MODEL.PRETRAINED
...
#     config_path = '/opt/ml/hrnet/pretrained/HRNet/config/hrnet_seg.yaml'
